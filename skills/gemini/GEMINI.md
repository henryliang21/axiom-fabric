...
> Add this guidance to your project's `GEMINI.md` (or `~/.gemini/GEMINI.md` to
> make it global), and wire the server with `af-mcp install --client gemini`.
> Canonical source: `axiom-fabric/src/axiom_fabric/mcp/agent_guide.md` (also the
